    ...
    */
    async postData(device_token, data) {
        ...
        if(devices[0]) {
            ...
            // Podla toho akeho je zariadenie typu, preparsuj data a zapis do databazy
            if(devices[0].type == "thermometer") {
                ...
                // Zapis do databazy
                let result = await this.db.writeData("thermometer", parsedData)
